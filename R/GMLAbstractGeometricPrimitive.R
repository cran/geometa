...
#'    This method is used to instantiate a GML abstract Geometric primitive
#'  }
#' }
#' 
...
#'
GMLAbstractGeometricPrimitive <- R6Class("GMLAbstractGeometricPrimitive",
  inherit = GMLAbstractGeometry,
  private = list(
    xmlElement = "AbstractGeometricPrimitive",
