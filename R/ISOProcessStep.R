...
#' @return Object of \code{\link[R6]{R6Class}} for modelling an ISO ProcessStep
...
#'   
#' @references 
#'   - ISO 19139 \url{https://schemas.isotc211.org/19139/-/gmd/1.0/gmd/#element_LI_ProcessStep}
#'   
#'   - ISO 19115-3 \url{https://schemas.isotc211.org/19115/-3/mrl/2.0/mrl/#element_LI_ProcessStep}
#' 
